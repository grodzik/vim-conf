...
map  <Leader>pt   :PBoB<CR>
vmap <Leader>pt   :<C-U>PBOB<CR>m'gv``
map  <Leader>pe   :PEoB<CR>
vmap <Leader>pe   :<C-U>PEoB<CR>m'gv``

map  <Leader>pv   <Leader>ptV<Leader>pe
map  <Leader>p<   <Leader>ptV<Leader>pe<
vmap <Leader>p<   <
map  <Leader>p>   <Leader>ptV<Leader>pe>
vmap <Leader>p>   >

map  <Leader>p#   :call PythonCommentSelection()<CR>
vmap <Leader>p#   :call PythonCommentSelection()<CR>
map  <Leader>pu   :call PythonUncommentSelection()<CR>
vmap <Leader>pu   :call PythonUncommentSelection()<CR>

map  <Leader>pc   :call PythonSelectObject("class")<CR>
map  <Leader>pd   :call PythonSelectObject("function")<CR>
